...
public class GenerateOverview {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String unitName : Arrays.asList("seconds", "minutes", "hours", "days", "weeks", "months", "years")) {
            JsonObject object = JsonParser.object().from(new FileInputStream(new File("buwa-phase/raw/times/" + unitName + ".json")));
        ...
        writeMapTo(outMap, JsonWriter.indent("  ").on(new FileOutputStream(new File("buwa-phase/raw/overview.json"))));
    }
