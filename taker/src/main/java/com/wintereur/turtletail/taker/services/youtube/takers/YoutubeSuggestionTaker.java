 ...
 * YoutubeSuggestionTaker.java is part of TurtleTail.
 *
...
public class YoutubeSuggestionTaker extends SuggestionTaker {

    public static final String CHARSET_UTF_8 = "UTF-8";

    public YoutubeSuggestionTaker(int serviceId) {
        super(serviceId);
    }
