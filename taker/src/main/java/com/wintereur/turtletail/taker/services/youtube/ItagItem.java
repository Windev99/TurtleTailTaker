...
import static com.wintereur.turtletail.taker.MediaFormat.*;
import static com.wintereur.turtletail.taker.services.youtube.ItagItem.ItagType.*;

public class ItagItem {
    /**
     * List can be found here https://github.com/rg3/youtube-dl/blob/master/youtube_dl/taker/youtube.py#L360
     */
