...
import static com.wintereur.turtletail.taker.subscription.SubscriptionTaker.ContentSource.INPUT_STREAM;

/**
 * Extract subscriptions from a YouTube export (OPML format supported)
 */
public class YoutubeSubscriptionTaker extends SubscriptionTaker {

    public YoutubeSubscriptionTaker(YoutubeService service) {
