...
public abstract class ListLinkHandlerFactory extends LinkHandlerFactory {
    ...
    /**
     * Will returns content filter the corresponding taker can handle like "channels", "videos", "music", etc.
     *
    ...
    /**
     * Will returns sort filter the corresponding taker can handle like "A-Z", "oldest first", "size", etc.
     *
     * @return filter that can be applied when building a query for getting a list
     */
