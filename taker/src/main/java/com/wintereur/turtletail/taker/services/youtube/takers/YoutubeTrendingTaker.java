 ...
 * YoutubeTrendingTaker.java is part of TurtleTail.
 *
...
public class YoutubeTrendingTaker extends KioskTaker {

    private Document doc;

    public YoutubeTrendingTaker(StreamingService service,
