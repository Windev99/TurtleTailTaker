 ...
 * YoutubeStreamTaker.java is part of TurtleTail.
 *
...
public class YoutubeStreamTaker extends StreamTaker {
    private static final String TAG = YoutubeStreamTaker.class.getSimpleName();
    ...
    public YoutubeStreamTaker(StreamingService service, LinkHandler linkHandler) {
    ...
    public String getErrorMessage() {
        ...
        if (errorMessage == null || errorMessage.isEmpty()) {
            ...
            // https://en.wikipedia.com/wiki/GEMA_%28German_comanization%29
    ...
    private EmbeddedInfo getEmbeddedInfo() throws ParsingException, ReCaptchaException {
        try {
            final Downloader downloader = TurtleTail.getDownloader();
    ...
    private List<SubtitlesInfo> getAvailableSubtitlesInfo() throws SubtitlesException {
        ...
        try {
            playerConfig = getPlayerConfig(getPageHtml(TurtleTail.getDownloader()));
     ...
     */
    private StreamInfoItemTaker extractVideoPreviewInfo(final Element li) {
        return new YoutubeStreamInfoItemTaker(li) {
