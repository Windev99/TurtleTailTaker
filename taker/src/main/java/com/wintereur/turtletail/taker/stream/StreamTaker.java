 ...
 * StreamTaker.java is part of TurtleTail.
 *
...
import com.wintereur.turtletail.taker.Taker;
import com.wintereur.turtletail.taker.StreamingService;
import com.wintereur.turtletail.taker.Subtitles;
 ...
 */
public abstract class StreamTaker extends Taker {

    public static final int NO_AGE_LIMIT = 0;

    public StreamTaker(StreamingService service, LinkHandler linkHandler) {
