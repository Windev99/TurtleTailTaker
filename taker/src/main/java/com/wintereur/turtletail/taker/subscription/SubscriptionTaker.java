package com.wintereur.turtletail.taker.subscription;
...
public abstract class SubscriptionTaker {

    /**
     * Exception that should be thrown when the input <b>do not</b> contain valid content that the
     * taker can parse (e.g. nonexistent user in case of a url extraction).
     */
    ...
    public SubscriptionTaker(StreamingService service, List<ContentSource> supportedSources) {
