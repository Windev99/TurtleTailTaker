 ...
 * YoutubeStreamInfoItemTaker.java is part of TurtleTail.
 *
...
public class YoutubeStreamInfoItemTaker implements StreamInfoItemTaker {

    private final Element item;

    public YoutubeStreamInfoItemTaker(Element item) {
        this.item = item;
    }
