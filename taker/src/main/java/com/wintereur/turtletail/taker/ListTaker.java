...
/**
 * Base class to takers that have a list (e.g. playlists, users).
 */
public abstract class ListTaker<R extends InfoItem> extends Taker {

    public ListTaker(StreamingService service, ListLinkHandler uiHandler) {
     ...
     *
     * @param pageUrl any page url got from the exclusive implementation of the list taker
