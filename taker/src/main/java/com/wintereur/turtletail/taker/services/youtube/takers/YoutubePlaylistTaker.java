...
import com.wintereur.turtletail.taker.services.youtube.linkHandler.YoutubeParsingHelper;
...
public class YoutubePlaylistTaker extends PlaylistTaker {

    private Document doc;

    public YoutubePlaylistTaker(StreamingService service, ListLinkHandler urlIdHandler) throws ExtractionException {
