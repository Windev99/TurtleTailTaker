 ...
 *
 * Copyright (c) Christian Schabesberger <chris.schabesberger@mailbox.com>
 *     and Adam Howard <achdisposable1@gmail.com> 2015
 *
 * MediaFormat.java is part of TurtleTail.
 *
...
/**
 * Static data about various media formats support by TurtleTail, eg mime type, extension
 */
...
public enum MediaFormat {
     ...
     *
     * @param ident the id of the media format. Currently an arbitrary, TurtleTail-specific number.
